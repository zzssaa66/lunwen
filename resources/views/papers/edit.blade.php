  ...
  <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
      <div class="flex items-center">
        ...
        <div>
          <h1 class="text-2xl font-bold text-gray-900">修改并重提交论文</h1>
          <p class="mt-1 text-sm text-gray-600">请修改论文信息并上传新的PDF文件</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <form method="POST" action="{{ route('papers.update', $paper) }}" enctype="multipart/form-data" class="p-6 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
          ...
          <textarea name="abstract" id="abstract" rows="6"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out"
                    placeholder="请输入论文摘要，简要描述研究内容、方法和结论">{{ old('abstract', $paper->abstract) }}</textarea>
          @error('abstract')
            <div class="mt-2 flex items-center text-sm text-red-600">
              <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
